...
function getDetail(alias){
    ...
    document.getElementById("insertDom").innerHTML=panel;	
        ...
        var waiver=	'<div class="panel panel-primary">'+
             ...
             '<div style="border:3px solid #73AD21; padding:10px;">'+ secondpart+   
              '</div>'+
