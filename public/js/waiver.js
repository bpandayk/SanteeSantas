...
if(!email){
  ...
  document.getElementById("applicantsInfo").innerHTML="<div class='form-group'><label for='name' style= 'padding-right:10px;'> Applicants Name: </label>" + "<span style='font-weight:bold;'>"+fname+ "&nbsp&nbsp" + lname + "</span> </div>" +
"<div class='form-group'><label for='name' style= 'padding-right:10px;'> Applicants Address: </label>" + "<span style='font-weight:bold;'>"+add1 + "&nbsp&nbsp" +add2+"</span></div>" + "<div class='form-group'><label for='name' style= 'padding-right:10px;'> City: </label>" + "<span style='font-weight:bold;'>"+city+ "</span>" +
"<label for='name' style= 'padding-right:10px; padding-left:30px;'> State: </label>" + "<span style='font-weight:bold;'>"+state+ "</span> <label for='name' style= 'padding-right:10px;padding-left:30px;'> Zip Code: </label>" + "<span style='font-weight:bold;'>"+zip+ "</span></div>"+ "<div class='form-group'><label for='name' style= 'padding-right:10px;'> Phone Number: </label>" + "<span style='font-weight:bold;'>"+ phone + "</span>"+"<label for='name' style= 'padding-right:10px; padding-left:30px;'> Email: </label>" + "<span style='font-weight:bold;'>"+email+ "</span></div>";
}
